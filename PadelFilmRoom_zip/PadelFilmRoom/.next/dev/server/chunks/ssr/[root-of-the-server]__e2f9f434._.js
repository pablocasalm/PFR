...
const translations = {
    es: {
        ...
        sectionMysteryLine2: 'Analizamos decisiones, contextos y patrones reales del pádel profesional.',
        ...
        sectionContentClose: 'Contenido para jugadores que quieren entender y aprender del juego, no solo verlo.',
        sectionChannelsTitle: 'El contenido empezará a aparecer muy pronto',
        sectionChannelsText: 'Iremos publicando análisis, clips y reflexiones en nuestros canales. Si te interesa este enfoque, síguenos y estate atento.',
        ...
        sectionHypeText: 'Estamos construyendo algo para jugadores que quieren pensar mejor cada punto.',
        sectionHypeText2: 'La lista de correo tendrá acceso anticipado, contenido exclusivo y prioridad cuando lancemos lo que viene.',
    ...
    en: {
        ...
        sectionMysteryLine2: 'We analyze decisions, contexts, and real patterns in pro padel.',
        ...
        sectionContentClose: 'Content for players who want to understand and learn the game, not just watch it.',
        sectionChannelsTitle: 'The content will start appearing very soon',
        sectionChannelsText: 'We\'ll publish analysis, clips, and reflections on our channels. If this approach interests you, follow us and stay tuned.',
        ...
        sectionHypeText: 'We\'re building something for players who want to think better every point.',
        sectionHypeText2: 'The email list gets early access, exclusive content, and priority when we launch what\'s next.',
...
function LanguageProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const stored = localStorage.getItem('padel-language');
    ...
    const t = (key)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["translations"][language][key];
    };
    if (!mounted) {
        return null;
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e2f9f434._.js.map
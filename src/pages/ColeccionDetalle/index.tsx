    ...
    return (
      <main className="pb-16 pt-16">
        <PageShell className="flex min-h-[60vh] flex-col items-center justify-center gap-4 text-center">
          <h1 className="text-2xl font-semibold text-white">ColecciÃ³n no encontrada</h1>
      ...
      <PageShell className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="space-y-2">
            <p className="text-sm uppercase tracking-[0.2em] text-neon-cyan/70">ColecciÃ³n</p>
        ...
        {clips.length > 0 ? (
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 text-white/60">
            Esta colecciÃ³n aÃºn no tiene clips publicados.
          </div>
        )}
      </PageShell>
    </main>

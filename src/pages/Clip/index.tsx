          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_340px] lg:items-start">
            <div className="space-y-4">
              <VideoPlayer
                ...
                className="w-full"
                playerClassName="aspect-video w-full rounded-2xl overflow-hidden"
                  ...
                  {suggestions.map((item) => {
                    ...
                    return (
                      <Link
                        ...
                        to={suggestionPath}
                        state={{ from: backTo }}
                        className="group flex items-center gap-3 rounded-2xl border border-white/10 bg-black/30 p-2 transition hover:border-neon-cyan/40"
                      >
                        <div className="h-14 w-20 overflow-hidden rounded-xl bg-black/60">
                          <img
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-white/60">{item.ideaKey}</p>
                        </div>
                      </Link>
                    )
                  })}

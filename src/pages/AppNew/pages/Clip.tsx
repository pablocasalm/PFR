...
/**
 * Clip — Vista de reproducción de un clip en /appnew/clip/:clipId.
...
const MobileTabBar = () => {
  const tabs = [
    { icon: Home, label: "Inicio", to: "/appnew/inicio" },
    { icon: Search, label: "Explorar", to: "/appnew/explorar", active: true },
    { icon: Bookmark, label: "Mi lista", to: "/appnew/mi-lista" },
    { icon: BarChart2, label: "Mi juego", to: "/appnew/mi-juego" },
  ]
  return (
  ...
  <main className="w-full space-y-6 py-6 pb-28 md:pb-8">
    ...
    <section className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        {NEXT.map((clip) => (
          <Link key={clip.title} to="/appnew/watch?c=1" className="group cursor-pointer">
  ...
  <main className="w-full py-6 pb-28 md:pb-8">
    ...
    <section className="mt-10 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 lg:grid-cols-6">
        {NEXT.map((clip) => (
          <Link key={clip.title} to="/appnew/watch?c=2" className="group cursor-pointer">
            <div className="relative overflow-hidden rounded-xl border border-white/10">

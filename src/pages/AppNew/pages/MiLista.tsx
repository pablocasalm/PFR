...
/**
 * MiLista — Contenido guardado del usuario en /appnew/mi-lista. Solo visual (datos mock).
 */
...
const ClipCard = ({ clip }: { clip: SavedClip }) => (
  <Link to="/appnew/watch?c=1" className="group block overflow-hidden rounded-xl border border-white/10 bg-white/[0.02] transition hover:border-white/20">
...
const VideoCard = ({ video }: { video: SavedVideo }) => (
  <Link to="/appnew/watch?v=1" className="group block overflow-hidden rounded-xl border border-white/10 bg-white/[0.02] transition hover:border-white/20">
    <div className="relative">
...
const RecentCard = ({ item }: { item: RecentItem }) => (
  <Link to={item.kind === "analisis" ? "/appnew/watch?v=1" : "/appnew/watch?c=1"} className="group block overflow-hidden rounded-xl border border-white/10 bg-white/[0.02] transition hover:border-white/20">
    <div className="relative">

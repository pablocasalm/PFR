...
const AdminInvites = () => {
  ...
  // Invita con un clic desde una solicitud pendiente: genera el código para ese email
  // (el backend marca la solicitud como atendida solo) y refresca las dos listas.
  const inviteFromRequest = async (email: string) => {

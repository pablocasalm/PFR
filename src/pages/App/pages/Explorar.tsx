...
/**
 * Explorar — Catálogo por conceptos del nuevo /app. Solo visual (datos mock).
...
const ClipCard = ({ clip }: { clip: Clip }) => (
  <Link to="/app/watch?c=1" className="group block cursor-pointer">
...
const AnalisisCard = ({ item }: { item: Analisis }) => (
  <Link to="/app/watch?v=1" className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/[0.02] p-3 transition hover:border-white/20">
